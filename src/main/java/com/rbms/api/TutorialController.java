package com.rbms.api;

import com.rbms.model.Tutorial;
import com.rbms.service.TutorialService;
...
public class TutorialController {
  ...
  public Mono<Tutorial> createTutorial(@RequestBody Tutorial tutorial) {
    ...
    return tutorialService.save(Tutorial.builder().title(tutorial.getTitle())
